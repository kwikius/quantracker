...
void hsync_setup()
{
   ...
   quan::stm32::module_enable<video_in::tim2_hsync_pin::port_type>();
   // TIM2_CH1
   quan::stm32::apply<
   video_in::tim2_hsync_pin,
   quan::stm32::gpio::mode::af1
   >();
   // gate trigger
   quan::stm32::module_enable<video_in::tim3_hsync_pin::port_type>();
   // TIM3_ETR
   quan::stm32::apply<
   video_in::tim3_hsync_pin,
...
void vsync_setup()
{
   quan::stm32::module_enable<video_in::vsync_pin::port_type>();
   // TIM3_CH1
   quan::stm32::apply<
      video_in::vsync_pin,
      quan::stm32::gpio::mode::af2
...
void odd_even_setup()
{
   quan::stm32::module_enable<video_in::odd_even_pin::port_type>();
   
   quan::stm32::apply<
      video_in::odd_even_pin,
