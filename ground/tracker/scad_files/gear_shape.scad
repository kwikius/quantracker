	...
	involute_facets=0)
{
	if (circular_pitch==false ) 
		echo("MCAD ERROR: gear module needs a  circular_pitch");
	...
	//echo ("Teeth:", number_of_teeth, " Pitch diameter:", pitch_diameter);
...
module gear_shape (
	number_of_teeth,
	pitch_radius,    //radius at which  gear teeth make contact
	root_radius,     // 
	base_radius,     // pitch_radius*cos(pressure_angle);
	outer_radius,    //
	half_thick_angle,  //
	involute_facets)   //number of facets?
{
*/
	union()
	{
